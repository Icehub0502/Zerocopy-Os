...
public class Server {
    ...
    static File folder = new File("D:/os-main/Server/"); // <<<<<<<<<<<<<<<<<<<<<<<<
    ...
    class ClientHandle implements Runnable {
        ...
        public ClientHandle(Socket socket, DataInputStream dis, DataOutputStream dos, SocketChannel socketChannel,
                int clientNo) {
            this.socket = socket;
            this.dis = dis;
            this.dos = dos;
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    String filePath = "D:/os-main/Server/" + namefile; // <<<<<<<<<<<<<<<<<<<<<<<<
